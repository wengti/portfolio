export const techData = {
    ...
    backend: ['Express.js', 'FastAPI', 'PostgreSQL', 'RESTful API'],
    ...
    highlight: ['Tailwind CSS', 'React', 'React Router', 'PostgreSQL', 'Supabase', 'Next.js', 'Git', 'Python', 'PyTorch', 'OpenAI API', 'Retrieval-Augmented Generation (RAG)', 'You Only Look Once (YOLO)', 'Pinecone', 'LangChain', 'LangGraph', 'pytest', 'Gemini API', 'FastAPI']
}